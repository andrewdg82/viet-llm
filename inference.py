...
class VietLLMGenerator:
    ...
    def generate(self, input: str, temperature: float=0.8, repetition_penalty: float=1.1, top_k: int=5, max_new_tokens: int=1024, early_stopping:bool=True, num_beams: int=5):
        st_time = time.time()
...
if __name__ == "__main__":
    ...
    sample_input = "chuyển sang dạng viết: mười giờ"
